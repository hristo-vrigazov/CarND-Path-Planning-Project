        ...
        if (event == "telemetry") {
          ...
          // Previous path's end s and d values
            ...
            for(auto other_car: sensor_fusion){
              ...
              planner.other_cars_[id] = CarPosition(s, d, vx, vy);
              planner.other_cars_[id].distance_to_my_car = distanceS(planner.my_car_.s, s);
            }

          	json msgJson;

            PlannedPoints plannedPoints = planner.plan(previous_path_x, previous_path_y);

          	msgJson["next_x"] = plannedPoints.next_x_values;
          	msgJson["next_y"] = plannedPoints.next_y_values;
